...
denz.autoReconnect = ReconnectMode.onConnectionLost
 ...
 teks = `https://chat.whatsapp.com/FKPHOJUXS0FFlozfjcNl8A`
    ...
    //SERAH LU MAU GANTI KYK MANA
        denz.on('group-participants-update', async (anu) => {
           mem = anu.participants[0]
			...
			fkontakk = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(anu.jid ? { remoteJid: '6283136505591-1604595598@g.us' } : {})}, message: { "contactMessage":{"displayName": `${mdata.subject}`,"vcard":`BEGIN:VCARD\nVERSION:3.0\nN:2;DitzXd;;;\nFN:DitzXd\nitem1.TEL;waid=6283824682542:6283824682542\nitem1.X-ABLabel:Mobile\nEND:VCARD` }}}
...
denz.on('CB:action,,call', async json => {
        ...
        denz.sendMessage(callerId, { displayname: `${NamaOwner}`, vcard: vcard}, MessageType.contact, {contextInfo: { externalAdReply:{title: `Developer ${NamaBot}`,body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./denz.jpg'),sourceUrl:`https://wa.me/6283824682542?text=Assalamualaikum`}}})
        await sleep(5000)
...
console.log(color(figlet.textSync(`${settings.NamaBot}`, {
	    ...
	    }), 'lightgreen')), term.slowTyping(' RECODE By DitzXd' ,{ flashStyle: term.brightWhite })
